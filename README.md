# Forked to add the ability to invalidate the cache for a CloudFront distro in one step 
...
| `DISTRIBUTION_ID` | The distribution id of the CloudFront distro you want to invalidate | `secret env` | No | N/A |
| `INVALIDATION_PATH` | The distribution id of the CloudFront distro you want to invalidate | `env` | No | `/*` files in root) |
